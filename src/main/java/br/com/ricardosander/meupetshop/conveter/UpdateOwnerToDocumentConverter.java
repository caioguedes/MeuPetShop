...
/**
 * Converter to a Owner to be update in a Document.
 */
public class UpdateOwnerToDocumentConverter implements Converter<Owner, Document> {
    ...
    public Document convert(Owner from) {
        ...
        if (!phones.isEmpty()) {
            ...
            document = document.append("phones", null);
        }
