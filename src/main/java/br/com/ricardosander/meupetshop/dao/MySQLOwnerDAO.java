        ...
        try (
            ...
            if (preparedStatement.execute()) {
                ...
                while (resultSet.next()) {
                    ...
                    owner.setPhone2(resultSet.getString("TELEFONE2") == null ? null : new Phone(resultSet.getString("TELEFONE2")));
                    owner.setPhone3(resultSet.getString("TELEFONE3") == null ? null : new Phone(resultSet.getString("TELEFONE3")));
                    owner.setPhone4(resultSet.getString("TELEFONE4") == null ? null : new Phone(resultSet.getString("TELEFONE4")));
                    owner.setPhone5(resultSet.getString("TELEFONE5") == null ? null : new Phone(resultSet.getString("TELEFONE5")));
